...
class ConfirmationDialog extends React.Component {
	...
	render() {
		const { onClose, value, ...other } = this.props;

		return (
			<Dialog onClose={this.handleBackdropClick} disableEscapeKeyDown
				maxWidth="sm" TransitionProps={{ onEntering: this.handleEntering }}
